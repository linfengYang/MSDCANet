...
def AugLPN_NILM(appliance, input_tensor, window_length, transfer_dense=False, transfer_cnn=False,
    ...
    Gru2_output = Conv2D(filters=64,
                            ...
                            padding='same',
                            activation='relu',
                            )(Gru2_output)  # Gru2_output change Sep_Add
    ...
    right_output = Add()([Gru2_output, Gru2_output_1])  # Gru2_output_1 change Sep_Add_1
...
def weights_loader(model, path):
    log('Loading aug weights from ' + path)
