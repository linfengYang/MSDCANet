...
from NILM_ModelsMSDCAN import weights_loader,get_MSDCAmodel1
...
if args.transfer:
    ...
    if (originModel):
        ...
        param_file = args.trained_model_dir + f'/MSDCANet{TrainNum}_{datasetName}' + args.appliance_name + f'_pointnet_model'
        # param_file = args.trained_model_dir + f'/MSDCANet{TrainNum}_{datasetName}' + args.appliance_name + f'combine_abdata_model'
# Loading weigths
